...
@section('content')
    @include('backend.includes.header', [
        ...
        'subTitle' => 'Create New Subscription with PayWay',
    ])
                                ...
                                <form id="subscription-form" method="POST" action="/admin/payway/subscription/create">
                                    ...
                                    <div class="form-section" id="section-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="plan_id" class="form-label">Select Plan <span
                                                            class="text-danger">*</span></label>
                                                    <select name="plan_id" id="plan_id" class="form-select" required>
                                                        ...
                                                        @foreach ($plans as $plan)
                                                            <option value="{{ $plan->id }}"
                                                                ...
                                                                data-name="{{ $plan->name }}">
                                                                {{ $plan->name }} -
                                                                ${{ number_format($plan->sell_price > 0 ? $plan->sell_price : $plan->price, 2) }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    <div class="invalid-feedback"></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="mb-3">
                                                    <label for="name" class="form-label">Subscription Name <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" name="name" id="name" class="form-control"
                                                        value="Default Subscription" required>
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                    ...
                                    <div class="form-section" id="section-2" style="display: none;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="location-info" id="pickup-info" style="display: none;">
                                                    ...
                                                    <input type="hidden" name="pickup_location[address]"
                                                        id="pickup_address_hidden">
                                                    <input type="hidden" name="pickup_location[latitude]"
                                                        id="pickup_latitude">
                                                    <input type="hidden" name="pickup_location[longitude]"
                                                        id="pickup_longitude">
                                                    <input type="hidden" name="pickup_location[street1]"
                                                        id="pickup_street1">
                                                    <input type="hidden" name="pickup_location[city]" id="pickup_city">
                                                    <input type="hidden" name="pickup_location[state]" id="pickup_state">
                                                    <input type="hidden" name="pickup_location[postal_code]"
                                                        id="pickup_postal_code">
                                                    <input type="hidden" name="pickup_location[country_code]"
                                                        id="pickup_country_code" value="AU">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="location-info" id="dropoff-info" style="display: none;">
                                                    <h6><span class="location-marker dropoff-marker"></span>Drop-off Location
                                                    </h6>
                                                    <p id="dropoff-address" class="mb-1"></p>
                                                    <small class="text-muted" id="dropoff-coords"></small>
                                                    <input type="hidden" name="dropoff_location[address]"
                                                        id="dropoff_address_hidden">
                                                    <input type="hidden" name="dropoff_location[latitude]"
                                                        id="dropoff_latitude">
                                                    <input type="hidden" name="dropoff_location[longitude]"
                                                        id="dropoff_longitude">
                                                    <input type="hidden" name="dropoff_location[street1]"
                                                        id="dropoff_street1">
                                                    ...
                                                    <input type="hidden" name="dropoff_location[postal_code]"
                                                        id="dropoff_postal_code">
                                                    <input type="hidden" name="dropoff_location[country_code]"
                                                        id="dropoff_country_code" value="AU">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="alert alert-info" id="location-instruction">
                                            ...
                                            <span id="location-instruction-text">Click "Select Pickup Location" and then click
                                                on the map to set pickup point.</span>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label for="location_search" class="form-label">Search Location
                                                        (Optional)</label>
                                                    <div class="input-group">
                                                        <input type="text" id="location_search" class="form-control"
                                                            placeholder="Type address, suburb, or landmark...">
                                                        <button type="button" class="btn btn-outline-primary"
                                                            id="searchLocationBtn">
                                                            <i class="fas fa-search"></i>
                                                        </button>
                                                    </div>
                                                    <small class="text-muted">You can search for a location and then fine-tune
                                                        by clicking on the map.</small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button type="button" class="btn btn-secondary" id="nextToPaymentBtn"
                                    ...
                                    <div class="form-section" id="section-3" style="display: none;">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="card_number" id="card_number"
                                                        class="form-control" placeholder="4564 7100 0000 0004" required
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label for="expiry_month" class="form-label">Month <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label for="expiry_year" class="form-label">Year <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label for="cvn" class="form-label">CVN <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label for="cardholder_name" class="form-label">Cardholder Name <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" name="cardholder_name" id="cardholder_name"
                                                        class="form-control" placeholder="Test Card" required>
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-section" id="section-4" style="display: none;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="billing_name" class="form-label">Full Name <span
                                                            class="text-danger">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label for="billing_phone" class="form-label">Phone <span
                                                            class="text-danger">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label for="billing_address_street1" class="form-label">Street Address
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" name="billing_address[street1]"
                                                        id="billing_address_street1" class="form-control" required>
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label for="billing_address_street2" class="form-label">Street Address 2
                                                        (Optional)</label>
                                                    <input type="text" name="billing_address[street2]"
                                                        id="billing_address_street2" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="billing_address_city" class="form-label">City <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" name="billing_address[city]"
                                                        id="billing_address_city" class="form-control" required>
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="billing_address_state" class="form-label">State <span
                                                            class="text-danger">*</span></label>
                                                    <select name="billing_address[state]" id="billing_address_state"
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="billing_address_postal_code" class="form-label">Postal Code
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" name="billing_address[postal_code]"
                                                        id="billing_address_postal_code" class="form-control" required
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label for="billing_address_country_code" class="form-label">Country <span
                                                            class="text-danger">*</span></label>
                                                    <select name="billing_address[country_code]"
                                                        id="billing_address_country_code" class="form-select" required>
                                    ...
                                    <div class="form-section" id="section-5" style="display: none;">
                                        <h5 class="mb-3"><i class="fas fa-check-circle me-2"></i>Review & Create
                                            Subscription</h5>
    ...
    <script>
        ...
        function loadGoogleMaps() {
            ...
            if (!GOOGLE_MAPS_CONFIG.apiKey) {
                showMapError('Google Maps API key not configured. Please add GOOGLE_MAPS_API_KEY to your .env file.',
                    'CONFIG_ERROR');
                return;
            }
            ...
            window.gm_authFailure = function() {
                showMapError('Google Maps authentication failed. Please check your API key and billing configuration.',
                    'AUTH_ERROR');
            };

            const script = document.createElement('script');
            script.src =
                `https://maps.googleapis.com/maps/api/js?key=${GOOGLE_MAPS_CONFIG.apiKey}&libraries=${GOOGLE_MAPS_CONFIG.libraries.join(',')}&callback=initMap&region=${GOOGLE_MAPS_CONFIG.region}&v=${GOOGLE_MAPS_CONFIG.version}&loading=async`;
            script.async = true;
            script.defer = true;
            script.onerror = function() {
                showMapError(
                    'Failed to load Google Maps script. Please check your internet connection and API configuration.',
                    'SCRIPT_LOAD_ERROR');
            };
            ...
            setTimeout(() => {
                if (!mapInitialized) {
                    showMapError('Google Maps took too long to load. Please refresh the page and try again.',
                        'TIMEOUT_ERROR');
                }
            }, 15000);
        }
        ...
        function setManualLocation(type) {
            ...
            if (hasPickup && hasDropoff) {
                ...
                updateInstruction(
                    `${type.charAt(0).toUpperCase() + type.slice(1)} location set. Now enter the ${nextType} location.`);
            }
        ...
        function initMap() {
            try {
                ...
                updateInstruction(
                    '✅ Google Maps loaded! Click "Select Pickup Location" to start selecting locations on the map.');
                ...
                if (error.message && error.message.toLowerCase().includes('billing')) {
                    showMapError('Google Maps billing is not enabled. Billing must be enabled even for development.',
                        'BILLING_ERROR');
                        ...
                        if (placesService) {
                            placesService.getDetails({
                                ...
                                if (status === google.maps.places.PlacesServiceStatus.OK && place
                                    ...
                                    updateInstruction(
                                        '🔍 Location found! Now click "Select Pickup" or "Select Drop-off" and click on the map.'
                                        );
                                } else {
            ...
            geocoder.geocode({
                ...
                if (status === 'OK' && results[0]) {
                    ...
                    if (hasPickup && hasDropoff) {
                        ...
                        const nextType = type === 'pickup' ? 'drop-off' : 'pickup';
                        updateInstruction(
                            `✅ ${type.charAt(0).toUpperCase() + type.slice(1)} location selected! Now select the ${nextType} location.`
                            );
                    }
                    ...
                    alert(
                        'Unable to get address for this location. Please try another location or use manual entry.');
                    selectingMode = null;
                    document.getElementById('selectPickupBtn').classList.remove('active');
                    document.getElementById('selectDropoffBtn').classList.remove('active');
                }
            ...
            if (navigator.geolocation) {
                ...
                navigator.geolocation.getCurrentPosition(function(position) {
                    ...
                    if (map && mapInitialized) {
                        ...
                        map.setZoom(15);
                        updateInstruction(
                            '📍 Current location found! Now click "Select Pickup" or "Select Drop-off" and then click on the map.'
                            );
                    } else {
                        updateInstruction(
                            'Current location found, but map not ready. Please use manual entry below.');
                    }
                }, function(error) {
        ...
        function validateCurrentStep(step) {
            switch (step) {
                ...
                case 4:
                    ...
                    const billingFields = ['billing_name', 'billing_email', 'billing_phone', 'billing_address_street1',
        ...
        window.addEventListener('error', function(e) {
            if (e.message && e.message.includes('Google Maps')) {
                if (e.message.includes('BillingNotEnabledMapError')) {
                    showMapError(
                        'Billing is not enabled for Google Maps. Please enable billing in Google Cloud Console.',
                        'BILLING_ERROR');
                } else if (e.message.includes('ApiNotActivatedMapError')) {
                    showMapError(
                        'Required Google Maps APIs are not enabled. Please enable Maps JavaScript API and Places API.',
                        'API_NOT_ACTIVATED');
                } else if (e.message.includes('InvalidKeyMapError')) {
                    showMapError('Invalid Google Maps API key. Please check your API key configuration.',
                        'AUTH_ERROR');
                } else if (e.message.includes('RefererNotAllowedMapError')) {
                    showMapError(
                        'Domain not allowed for this API key. Please add your domain to API key restrictions.',
                        'AUTH_ERROR');
                }
            }
        });
        ...
        document.addEventListener('DOMContentLoaded', function() {
                ...
                if (selectedOption && selectedOption.dataset.name) {
                    ...
                    if (planOption && planOption.dataset.name) {
                        document.getElementById('name').value =
                            `${selectedOption.dataset.name} - ${planOption.dataset.name}`;
                    }
                }
            });
            ...
            document.getElementById('plan_id').addEventListener('change', function() {
                ...
                if (selectedOption && userOption && selectedOption.dataset.name && userOption.dataset
                    .name) {
                    document.getElementById('name').value =
                        `${userOption.dataset.name} - ${selectedOption.dataset.name}`;
                }
            });
