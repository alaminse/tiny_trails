...
@section('css')
    <style>
        ...
        .cal-day.cal-selected {
            ...
            font-weight: 700;
            box-shadow: 0 2px 4px rgba(13, 110, 253, .4);
        }
                    ...
                    <div class="col-12">
                        <div class="card card-primary card-outline mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('admin.ride.assign.index') }}" class="btn btn-sm btn-outline-secondary">← Back
                                    to List</a>
                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item px-0 d-flex justify-content-between">
                                                        ...
                                                        <span class="text-end"
                                                            style="max-width:60%">{{ $subscription->pickupLocation?->address }}</span>
                                                    </li>
                                                    <li class="list-group-item px-0 d-flex justify-content-between">
                                                        <span class="text-muted fw-semibold">Dropoff</span>
                                                        <span class="text-end"
                                                            style="max-width:60%">{{ $subscription->dropoffLocation?->address }}</span>
                                                    </li>
                                                    <li class="list-group-item px-0 d-flex justify-content-between">
                                                        <span class="text-muted fw-semibold">Fare</span>
                                                        <span class="fw-bold text-success">
                                                            ${{ number_format($subscription->kid_wage?->sell_price ?? $subscription->plan?->sell_price, 2) }}
                                                            AUD
                                                        </span>
                                                    </li>
                                                    <li class="list-group-item px-0 d-flex justify-content-between">
                                    ...
                                    <div class="card shadow-sm border-0 rounded-3 mb-4">
                                        <div class="card-header bg-light border-bottom">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <span class="badge bg-primary" id="selectedCountBadge">0 days
                                                        selected</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="auto-select-bar">
                                                ...
                                                You can click any highlighted day to <strong>deselect</strong> it, or click an
                                                unselected day to add it back.
                                            </div>
                                            ...
                                            <div class="d-flex gap-3 mt-3 flex-wrap small">
                                                <span><span
                                                        style="display:inline-block;width:14px;height:14px;background:#0d6efd;border-radius:3px;vertical-align:middle"></span>
                                                    Selected</span>
                                                <span><span
                                                        style="display:inline-block;width:14px;height:14px;background:#fff5f5;border:1px solid #dc3545;border-radius:3px;vertical-align:middle"></span>
                                                    Weekend</span>
                                                <span><span
                                                        style="display:inline-block;width:14px;height:14px;background:#f8f9fa;border:1px solid #dee2e6;border-radius:3px;vertical-align:middle;opacity:.5"></span>
                                                    Out of range</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card shadow-sm border-0 rounded-3 mb-4">
                                        <div
                                            ...
                                            <div class="d-flex gap-2">
                                                <button type="button" class="btn btn-sm btn-outline-primary"
                                                    id="btnSelectAll">✔ Select All</button>
                                        ...
                                        <div class="card-body" id="dateRowsContainer">
                                            <div class="empty-dates" id="emptyState">
                                                ...
                                                <div class="small text-muted">All weekdays are auto-selected — use the calendar
                                                    to adjust.</div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(function() {
            ...
            const rangeStart = new Date(
                '{{ $subscription->kid_wage?->start_date ?? \Carbon\Carbon::parse($subscription->created_at)->format('Y-m-d') }}'
                );
            const rangeEnd = new Date(
                '{{ $subscription->kid_wage?->end_date ?? \Carbon\Carbon::parse($subscription->ends_at)->format('Y-m-d') }}'
                );
            ...
            function renderDateRows() {
                ...
                $('#selectedCountBadge').text(count === 0 ? '0 days selected' :
