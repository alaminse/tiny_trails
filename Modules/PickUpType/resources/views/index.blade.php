...
@section('content')
    @include('backend.includes.header', [
        'mainTitle' => 'Pickup Type',
        'subTitle' => 'Pickup Type Management',
    ])
                    ...
                    <div class="col-12">
                        <div class="card card-primary card-outline mb-4">
                            <div class="d-flex">
                                ...
                                @can('create-pickup')
                                    <div class="p-2">
                                        <a href="#" class="btn btn-sm btn-gradient-success" id="addPickupBtn">Add Pickup
                                            Type</a>
                                    </div>
                                @endcan
                            </div>
    ...
    <!-- Modal -->
    @canany(['create-pickup', 'edit-pickup'])
                    ...
                    <form id="pickupForm">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="min_notice_minutes" id="min_notice_minutes" class="form-control"
                                    min="0" required>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="requires_instant_notification" id="requires_instant_notification"
