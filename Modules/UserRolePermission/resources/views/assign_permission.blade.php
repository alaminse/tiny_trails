                                    ...
                                    <div class="perm-wrapper" id="permWrapper">
                                        ...
                                        @foreach ($groupedPermissions as $moduleKey => $modulePermissions)
                                            @php
                                                ...
                                                $checkedCount = $modulePermissions
                                                    ->filter(fn($p) => in_array($p->name, $rolePermissionNames))
                                                    ->count();
                                            ...
                                            <div class="perm-card" data-module="{{ $moduleKey }}">
                                                ...
                                                <div class="perm-card-header" data-bs-toggle="collapse"
                                                    data-bs-target="#module_{{ $moduleKey }}" aria-expanded="true">
                                                    ...
                                                    <div class="perm-module-title">
                                                        ...
                                                        {{ $modLabel }}
                                                        <span class="perm-badge {{ $badgeClass }}"
                                                            id="badge_{{ $moduleKey }}">
                                                    ...
                                                    <div class="perm-header-right">
                                                        ...
                                                        <i class="fas fa-chevron-down collapse-caret"
                                                            id="caret_{{ $moduleKey }}"></i>
                                                    </div>
                                                </div>
