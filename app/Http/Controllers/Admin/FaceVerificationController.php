...
class FaceVerificationController extends Controller
{
    ...
    public function index()
    {
        $drivers = Driver::with('user')
            ->where('status', 'active')
            ->orderByRaw("FIELD(face_verification_status, 'expiring', 'verified', 'expired', 'unverified')")
            ->get();
        ...
        $expiredCount   = $drivers->whereIn('face_verification_status', ['expired', 'unverified'])->count();
