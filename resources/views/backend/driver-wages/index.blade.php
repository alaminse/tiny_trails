                                        ...
                                        <table class="table table-hover align-middle mb-0">
                                            ...
                                            <tbody>
                                                @forelse($wages ?? [] as $wage)
                                                    <tr>
                                                        <td>
                                                            <strong>{{ $wage->driver->user->first_name }} {{ $wage->driver->user->last_name }}</strong>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <span class="fs-5 fw-bold text-success">${{ number_format($wage->rate_amount, 2) }}</span>
                                                            <small class="text-muted">/ {{ $wage->rate_type === 'daily' ? 'day' : 'hr' }}</small>
                                                        </td>
                                                        <td><code>{{ \Carbon\Carbon::parse($wage->effective_from)->format('d M Y') }}</code></td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <span class="badge {{ $wage->status === 'active' ? 'bg-success' : 'bg-secondary' }}">
                                                                {{ ucfirst($wage->status) }}
                                                            </span>
                                                        </td>
                                                        <td class="small text-muted">{{ $wage->createdBy->first_name ?? '—' }}</td>
                                                        <td>
                                                            <button class="btn btn-sm btn-outline-secondary"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#modalWage"
                                                                    data-id="{{ $wage->id }}"
                                                ...
                                                @empty
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="fs-5 fw-bold text-success">$180.00</span> <small class="text-muted">/ day</small></td>
                                                        <td><code>01 Jan 2026</code></td>
                                                        <td><span class="text-muted">Ongoing</span></td>
                                                        <td><span class="badge bg-success">Active</span></td>
                                                        <td class="small text-muted">Super Admin</td>
                                                        <td><button class="btn btn-sm btn-outline-secondary">✏️ Edit</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Sarah K.</strong></td>
                                                        <td><span class="badge bg-info text-dark">Hourly</span></td>
                                                        <td><span class="fs-5 fw-bold text-success">$32.00</span> <small class="text-muted">/ hr</small></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="badge bg-primary">Daily</span></td>
                                                        <td><span class="fs-5 fw-bold text-muted">$165.00</span> <small class="text-muted">/ day</small></td>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="rate_type" id="wRateType"
                                        required onchange="updateRateLabel()">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="rate_amount"
                                       id="wAmount" placeholder="e.g. 180.00" step="0.01" min="0" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" name="effective_from" id="wFrom" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="notes" id="wNotes" rows="2"
                                          placeholder="Not visible to driver..."></textarea>
                            </div>
                        </div>
                    </div>
