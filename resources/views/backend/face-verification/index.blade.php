...
@section('css')
    <style>
        ...
        .driver-avatar.verified {
            border-color: #198754;
        }

        .driver-avatar.expiring {
            border-color: #ffc107;
        }

        .driver-avatar.expired {
            border-color: #dc3545;
        }
    </style>
@endsection
                                ...
                                <div class="card shadow-sm border-0 rounded-3 mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @forelse($drivers ?? [] as $driver)
                                            @php
                                                $isVerified =
                                                    $driver->face_verification_status === 'verified' &&
                                                ...
                                                $minsLeft = $driver->face_verified_until
                                                    ? max(
                                                        0,
                                                        now()->diffInMinutes(
                                                            \Carbon\Carbon::parse($driver->face_verified_until),
                                                            false,
                                                        ),
                                                    )
                                                    : 0;
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center gap-3 flex-wrap">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <div class="fw-bold">{{ $driver->user->first_name }}
                                                                {{ $driver->user->last_name }}</div>
