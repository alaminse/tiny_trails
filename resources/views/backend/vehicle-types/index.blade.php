...
@section('content')
                        ...
                        <div class="card card-primary card-outline mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                @can('create-vehicle-types')
                                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalVehicle">
                                        ...
                                        <div class="row g-3">
                                            @forelse($vehicleTypes ?? [] as $vt)
                                                <div class="col-6 col-md-3">
                                                    <div class="vtype-card {{ auth()->user()->can('edit-vehicle-types') ? '' : 'pe-none' }}"
                                                        @can('edit-vehicle-types')
                                                    data-bs-toggle="modal" data-bs-target="#modalVehicle"
                                                    @endcan
                                                        data-id="{{ $vt->id }}" data-name="{{ $vt->name }}"
                                                        data-capacity="{{ $vt->max_capacity }}"
                                                        data-desc="{{ $vt->description }}" data-status="{{ $vt->status }}">
                                                        <div class="vicon">
                                                        ...
                                                        <div class="d-flex gap-1 justify-content-center flex-wrap">
                                                            <span
                                                                class="badge {{ $vt->status === 'active' ? 'bg-success' : 'bg-secondary' }}">
                                                                {{ ucfirst($vt->status) }}
                                                            </span>
                                                            <span
                                                ...
                                                <div class="col-6 col-md-3">
                                                    <div class="vtype-card">
                                                        ...
                                                        <div class="d-flex gap-1 justify-content-center flex-wrap">
                                                            ...
                                                            <span
                                                                class="badge bg-primary-subtle text-primary border border-primary-subtle">4
                                                                drivers</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="vtype-card">
                                                        ...
                                                        <div class="d-flex gap-1 justify-content-center flex-wrap">
                                                            <span class="badge bg-success">Active</span>
                                                            <span
                                                                class="badge bg-primary-subtle text-primary border border-primary-subtle">6
                                                                drivers</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="vtype-card">
                                                        ...
                                                        <div class="d-flex gap-1 justify-content-center flex-wrap">
                                                            <span class="badge bg-success">Active</span>
                                                            <span
                                                                class="badge bg-primary-subtle text-primary border border-primary-subtle">2
                                                                drivers</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-6 col-md-3">
                                                @can('create-vehicle-types')
                                                    <div class="vtype-card add-card" data-bs-toggle="modal"
                                            ...
                                            <table class="table table-hover align-middle mb-0">
                                                ...
                                                <tbody>
                                                    @forelse($drivers ?? [] as $driver)
                                                        <tr>
                                                            <td>
                                                                <strong>{{ $driver->user->first_name }}
                                                                    {{ $driver->user->last_name }}</strong>
                                                            </td>
                                                            <td>
                                                    ...
                                                    @empty
                                                        <tr>
                                                            ...
                                                            <td>🚐 7-Seater Van</td>
                                                            <td><code>VIC-4821</code></td>
                                                            <td><span class="badge bg-info text-dark">6 kids</span></td>
                                                            <td><span class="badge bg-primary">🔵 On Trip</span></td>
                                                            <td><button class="btn btn-sm btn-outline-secondary">Change
                                                                    Vehicle</button></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Sarah K.</strong></td>
                                                            <td>🚗 4-Seater Sedan</td>
                                                            <td><code>VIC-3310</code></td>
                                                            <td><span class="badge bg-info text-dark">3 kids</span></td>
                                                            <td><span class="badge bg-success">✅ Ready</span></td>
                                                            <td><button class="btn btn-sm btn-outline-secondary">Change
                                                                    Vehicle</button></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Tom W.</strong></td>
                                                            <td><span class="text-muted">Not Assigned</span></td>
                                                            <td><code>VIC-5512</code></td>
                                                            <td><span class="badge bg-secondary">—</span></td>
                                                            <td><span class="badge bg-secondary">⚫ Offline</span></td>
                                                            <td><button class="btn btn-sm btn-primary">Assign Vehicle</button>
                                                            </td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
    ...
    @canany(['create-vehicle-types', 'edit-vehicle-types'])
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ route('admin.vehicle.types.assign') }}" method="POST">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title">Assign Vehicle to <span id="aDriverName" class="text-primary"></span>
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
